...
/**
    ...
    jar.
*/
public class WeblogicDeploymentTool extends IntermediateGenericDeploymentTool {
    /** EJB11 id */
    ...
    protected boolean isRebuildRequired(File genericJarFile, File weblogicJarFile) {
        return isRebuildRequiredExtracted(weblogicJarFile, genericJarFile,
				"Checking if weblogic Jar needs to be rebuilt for jar ", " not present in weblogic jar",
