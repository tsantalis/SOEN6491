 ...
 *
 */
public class WebsphereDeploymentTool extends IntermediateGenericDeploymentTool {
    ...
    protected boolean isRebuildRequired(File genericJarFile, File websphereJarFile) {
        return isRebuildRequiredExtracted(websphereJarFile, genericJarFile,
				"Checking if websphere Jar needs to be rebuilt for jar ", " not present in websphere jar",
